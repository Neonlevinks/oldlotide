...
const assertArraysEqual = (actual, expected) => eqArrays(actual, expected) ? console.log(`✅✅✅ Assertion Passed: ${actual} === ${expected}`) : console.log("🛑🛑🛑 Assertion Failed, the arrays are not equal");
